...
export default function UploadPDF() {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/api/uploads/pdf`, {
        method: 'POST',
        body: formData
      });
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8 relative">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Upload Course Notes</h1>
        <p className="text-sm text-gray-500">Upload PDF materials, assignments, and reading resources</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white">
            <h2 className="text-lg font-bold text-gray-900 mb-6 tracking-tight">Upload Document</h2>
            ...
            {!file ? (
              ...
              >
                ...
                <p className="text-xs text-gray-500 mb-8 font-medium">or click to browse from your computer (PDF only)</p>
                <input 
                  ref={inputRef}
                  type="file" 
        ...
        <div className="space-y-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white">
            <h2 className="text-lg font-bold text-gray-900 mb-6 tracking-tight">Document Details</h2>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-700 uppercase tracking-wide">Document Title</label>
              ...
              <div className="space-y-2">
                ...
                <textarea id="descInput" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#7b61ff] focus:bg-white transition-colors text-sm font-medium text-gray-900 h-28 resize-none" placeholder="Brief description of the document..."></textarea>
              </div>
              <button 
